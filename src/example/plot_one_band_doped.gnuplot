...
set ylabel "d"
ns="0.4 0.6 0.8 0.9"
plot for [n in ns ] dmftfile(n)  u 1:2 t ""  pt 5 lc "black", for [n in ns ] n2file(n) u 1:5 w l t "" lc "green", for [n in ns ] n3file(n) u 1:5 w l t "" lc "red", NaN  t "DMFT(NRG)" w p pt 5  lc "black", NaN w l lc "green" t "N=2", NaN w l lc "red" t "N=3"
